    ...
    <>
      <main className="h-full overflow-hidden w-full">
        ...
        <div className="max-w-5xl grid grid-cols-2 justify-self-center gap-x-6 gap-y-12 w-full  h-full">
          ...
          <GenericCardHomePage textFooter="Camas e Colchões" alt="Imagem do Sofá" href="/bedsAndMattress" backgroundImage={sofaImage} />
          <GenericCardHomePage textFooter="Sala" alt="Imagem do Sofá" href="/room" backgroundImage={sofaImage} />
          <GenericCardHomePage textFooter="Cozinha" alt="Imagem do Sofá" href="/kitchen" backgroundImage={sofaImage} />
        </div>
      </main >
    </>
  );
